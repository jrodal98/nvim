...
M.mappings.plugins = {
   ...
   lspconfig = {
      ...
      implementation = "gi",
      signature_help = "gk",
      -- the <leader><F3> is my way of trying to "nil" the keys,
      -- since they slow down my <leader>w save keybinding.
      add_workspace_folder = "<leader><F3>",
      remove_workspace_folder = "<leader><F3>",
      list_workspace_folders = "<leader><F3>",
